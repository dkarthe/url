...
class Admin{
   ...
   * @since 5.0
   **/
  protected $actions = ["ads","users","urls","payments","pages","settings","themes","languages","help","search","subscription","tools","plans"];
  /**
   * Config
   * @since 4.0
   **/
  ...
  protected function tools_newsletter(){
    ...
    Main::cdn("ckeditor", NULL, TRUE);
    Main::admin_add("<script>$(document).ready(function() { CKEDITOR.replace( 'editor' ); });</script>","custom", FALSE);
